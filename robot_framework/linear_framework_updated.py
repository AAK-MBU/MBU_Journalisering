...
#             handle_error("Business Error", error, None, orchestrator_connection, config.SMTP_SERVER)
#             break
...
#             error_count += 1
#             handle_error(f"Process Error #{error_count}", error, None, orchestrator_connection, config.SMTP_SERVER)

...
from mbu_dev_shared_components.exception_handling.exception_handler import BusinessError, handle_error, log_exception
...
def main():
    ...
    for _ in range(config.MAX_RETRY_COUNT):
        try:
            ...
            while task_count < config.MAX_TASK_COUNT:
                ...
                try:
                    ...
                    handle_error("Business Error", error, queue_element, orchestrator_connection, config.SMTP_SERVER)
        ...
        # pylint: disable-next = broad-exception-caught
            ...
            error_count += 1
            handle_error(f"Process Error #{error_count}", error, queue_element, orchestrator_connection, config.SMTP_SERVER)
